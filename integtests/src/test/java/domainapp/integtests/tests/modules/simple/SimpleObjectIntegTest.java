...
public class SimpleObjectIntegTest extends DomainAppIntegTest {
    ...
    RecreatePresenters fs;
    Session sessionPojo;
    Session sessionWrapped;

    @Before
    public void setUp() throws Exception {
        // given
        fs = new RecreatePresenters().setNumber(1);
        fixtureScripts.runFixtureScript(fs, null);

        sessionPojo = fs.getSessions().get(0);

        assertThat(sessionPojo).isNotNull();
        sessionWrapped = wrap(sessionPojo);
    }
    ...
    public static class Name extends SimpleObjectIntegTest {
        ...
        public void accessible() throws Exception {
            // when
            final String name = sessionWrapped.getName();
            // then
    ...
    public static class UpdateName extends SimpleObjectIntegTest {
        ...
        public void canBeUpdatedDirectly() throws Exception {
            ...
            // when
            sessionWrapped.setName("new name");

            // then
            assertThat(sessionWrapped.getName()).isEqualTo("new name");
        }
    ...
    public static class Title extends SimpleObjectIntegTest {
        ...
        public void interpolatesName() throws Exception {
            ...
            // when
            final String title = container.titleOf(sessionWrapped);
    ...
    public static class DataNucleusId extends SimpleObjectIntegTest {
        ...
        public void shouldBePopulated() throws Exception {
            // when
            final Long id = mixin(Persistable_datanucleusIdLong.class, sessionPojo).$$();
            // then
    ...
    public static class DataNucleusVersionTimestamp extends SimpleObjectIntegTest {
        ...
        public void shouldBePopulated() throws Exception {
            // when
            final Timestamp timestamp = mixin(Persistable_datanucleusVersionTimestamp.class, sessionPojo).$$();
            // then
